...
const questions = [
  ...
  {
    question: "In Python, what is the superclass of all classes?",
  ...
  {
    question:
      "Which of the following statements about interfaces in Python is false?",
    options: [
...
function Python() {
  ...
  return (
    <div className="container mx-auto my-28 p-2">
      <h1 className="text-center font-bold text-3xl">Python Mcq Test</h1>
