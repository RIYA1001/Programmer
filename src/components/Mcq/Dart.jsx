...
const questions = [
  ...
  {
    question: "In Dart, what is the superclass of all classes?",
  ...
  {
    question:
      "Which of the following statements about interfaces in Dart is false?",
    options: [
...
function Dart() {
  ...
  return (
    <div className="container mx-auto my-28 p-2">
      <h1 className="text-center font-bold text-3xl">Dart Mcq Test</h1>
