            ...
            <div className="text-center container mx-auto mt-28 mb-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4">
                    ...
                    <section className="my-3 mx-5 bg-yellow-400 text-gray-900 p-6 rounded-lg shadow-md">
                        ...
                        <Link to="/liveLectures" className="hover:text-green-500 text-blue-600">Learn More</Link> <br /><br />
                    </section>
                    ...
                    <section className="my-3 mx-5 bg-yellow-400 text-gray-900 p-6 rounded-lg shadow-md">
                        ...
                        <Link to="/videos" className="hover:text-green-500 text-blue-600">Learn More</Link> <br /><br />
                    </section>
                    ...
                    <section className="my-3 mx-5 bg-yellow-400 text-gray-900 p-6 rounded-lg shadow-md">
                        ...
                        <Link to="/games" className="hover:text-green-500 text-blue-600">Learn More</Link> <br /><br />
                    </section>
                    ...
                    <section className="my-3 mx-5 bg-yellow-400 text-gray-900 p-6 rounded-lg shadow-md">
                        ...
                        <Link to="/notes" className="hover:text-green-500 text-blue-600">Learn More</Link> <br /><br />
                    </section>
