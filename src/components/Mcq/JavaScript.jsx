...
const questions = [
  ...
  {
    question: "In JavaScript, what is the superclass of all classes?",
  ...
  {
    question:
      "Which of the following statements about interfaces in JavaScript is false?",
    options: [
...
function JavaScript() {
  ...
  return (
    <div className="container mx-auto my-28 p-2">
      <h1 className="text-center font-bold text-3xl">JavaScript Mcq Test</h1>
