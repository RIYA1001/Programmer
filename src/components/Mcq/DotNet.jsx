...
const questions = [
  ...
  {
    question: "In DotNet, what is the superclass of all classes?",
  ...
  {
    question:
      "Which of the following statements about interfaces in DotNet is false?",
    options: [
...
function DotNet() {
  ...
  return (
    <div className="container mx-auto my-28 p-2">
      <h1 className="text-center font-bold text-3xl">DotNet Mcq Test</h1>
