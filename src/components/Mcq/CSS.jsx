...
const questions = [
  ...
  {
    question: "In CSS, what is the superclass of all classes?",
  ...
  {
    question:
      "Which of the following statements about interfaces in CSS is false?",
    options: [
...
function CSS() {
  ...
  return (
    <div className="container mx-auto my-28 p-2">
      <h1 className="text-center font-bold text-3xl">CSS Mcq Test</h1>
