...
const questions = [
  ...
  {
    question: "In Swift, what is the superclass of all classes?",
  ...
  {
    question:
      "Which of the following statements about interfaces in Swift is false?",
    options: [
...
function Swift() {
  ...
  return (
    <div className="container mx-auto my-28 p-2">
      <h1 className="text-center font-bold text-3xl">Swift Mcq Test</h1>
