...
const questions = [
  ...
  {
    question: "In C, what is the superclass of all classes?",
  ...
  {
    question:
      "Which of the following statements about interfaces in C is false?",
    options: [
...
function C() {
  ...
  return (
    <div className="container mx-auto my-28 p-2">
      <h1 className="text-center font-bold text-3xl">C Mcq Test</h1>
