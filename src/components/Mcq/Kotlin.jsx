...
const questions = [
  ...
  {
    question: "In Kotlin, what is the superclass of all classes?",
  ...
  {
    question:
      "Which of the following statements about interfaces in Kotlin is false?",
    options: [
...
function Kotlin() {
  ...
  return (
    <div className="container mx-auto my-28 p-2">
      <h1 className="text-center font-bold text-3xl">Kotlin Mcq Test</h1>
