...
const questions = [
  ...
  {
    question: "In SQL, what is the superclass of all classes?",
  ...
  {
    question:
      "Which of the following statements about interfaces in SQL is false?",
    options: [
...
function SQL() {
  ...
  return (
    <div className="container mx-auto my-28 p-2">
      <h1 className="text-center font-bold text-3xl">SQL Mcq Test</h1>
