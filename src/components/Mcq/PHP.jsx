...
const questions = [
  ...
  {
    question: "In PHP, what is the superclass of all classes?",
  ...
  {
    question:
      "Which of the following statements about interfaces in PHP is false?",
    options: [
...
function PHP() {
  ...
  return (
    <div className="container mx-auto my-28 p-2">
      <h1 className="text-center font-bold text-3xl">PHP Mcq Test</h1>
