...
const questions = [
  ...
  {
    question: "In Cplusplus, what is the superclass of all classes?",
  ...
  {
    question:
      "Which of the following statements about interfaces in Cplusplus is false?",
    options: [
...
function Cplusplus() {
  ...
  return (
    <div className="container mx-auto my-28 p-2">
      <h1 className="text-center font-bold text-3xl">Cplusplus Mcq Test</h1>
